...
class TransactionHistoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // [MODIFIKASI] Ambil user saat ini
    ...
    return Scaffold(
      ...
      body:
          // [MODIFIKASI] Cek apakah user sudah login atau belum
          user == null
              ? const Center(
                  child: Text(
              ...
              : StreamBuilder<QuerySnapshot>(
                  // Ambil data hanya jika user tidak null
                  stream: FirebaseFirestore.instance
                      .collection('bookings')
                      .where('userId',
                          isEqualTo:
                              user.uid) // Gunakan user.uid yang sudah pasti ada
                  ...
                  builder: (context, snapshot) {
                    ...
                    // Pengecekan ini sekarang hanya berlaku untuk user yang sudah login
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if (items.isEmpty) {
                          return const Card(
                              child: ListTile(
                                  title: Text('Data booking tidak lengkap.')));
                        }
                        ...
                        final originalTotal = bookingData[
                            'originalTotalAmount']; // Bisa jadi null
                        ...
                        // Perhitungan harga lapang dasar
                        num priceLapang = totalAmount;
                        if (isMember && originalTotal != null) {
                          priceLapang = originalTotal;
                        }
                        priceLapang = priceLapang -
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                    'Status Member: ${isMember ? 'Ya' : 'Tidak'}'),
                                const SizedBox(height: 16),
